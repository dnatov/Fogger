...
namespace TestApi
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            FogBugzApiWrapper Api = new FogBugzApiWrapper(Domain, UserName, Password);

            //Get the current filters availiable
            List<Filter> filters = Api.GetFilters();
            ...
            List<Case> cases = Api.SearchCurrentFilter();
            ...
            //Edit Case
            FogBugzApiWrapper.CaseManager.EditCase(caseToEdit);
